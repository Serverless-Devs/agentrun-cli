...
| `sync-skills` |  | Sync platform skills to AI tool local skill directories (Claude Code, Codex, GitHub Copilot, Cursor, Qoder) | [en](./docs/en/sync-skills.md) · [zh](./docs/zh/sync-skills.md) |
